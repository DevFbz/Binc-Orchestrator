...
export default function ReportsPage() {
  ...
  return <main className={styles.page}>
    ...
    <section className={styles.hero}><div><p className={styles.kicker}>RELATÓRIOS</p><h1>Visão executiva<span>.</span></h1><p className={styles.subtitle}>Uma leitura consolidada da operação, com período, fontes e limitações declarados.</p></div><div className={styles.exportActions}><a className={styles.primary} href="/api/reports/export?format=csv" download><FileText size={16} /> CSV</a><a className={styles.secondary} href="/api/reports/export?format=pdf" download><FileText size={16} /> PDF</a></div></section>
