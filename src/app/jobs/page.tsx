...
type Data = { jobs?: { jobs?: Job[]; summary?: { total: number; active: number; paused: number; approval_required: number } }; permissions?: { can_manage_jobs?: boolean } };
...
export default function JobsPage() {
  ...
  const canManageJobs = data?.permissions?.can_manage_jobs === true;
