...
type Section = "overview" | "projects" | "campaigns" | "tasks" | "automations" | "governance" | "reports" | "docs" | "terminal";
...
const navItems: { id: Section; label: string; icon: typeof LayoutDashboard }[] = [
  ...
  { id: "campaigns", label: "Campanhas", icon: Camera },
...
const titles: Record<Section, [string, string]> = {
  ...
  campaigns: ["Campanhas", "Produtos, aprovações e publicações do Instagram."],
...
function getGreeting(date: Date) {
  const hour = Number(new Intl.DateTimeFormat("pt-BR", { hour: "numeric", hourCycle: "h23", timeZone: "America/Sao_Paulo" }).format(date));
