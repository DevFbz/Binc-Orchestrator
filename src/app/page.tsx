...
export default function Home() {
  ...
  return <main className={styles.page}>
    <header className={styles.header}><div><p className={styles.kicker}>VISÃO GERAL</p><h1>Operação Binc</h1><p>Estado consolidado de projetos, automações e serviços conectados.</p></div><span className={styles.live}><i /> {error ? "Control plane indisponível" : "Control plane conectado"}</span></header>
