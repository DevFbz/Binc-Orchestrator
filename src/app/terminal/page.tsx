...
type Data = { telegramEvents?: { events?: Event[] }; permissions?: { can_send_telegram?: boolean } };
...
export default function TerminalPage() {
  ...
  const canSendTelegram = data?.permissions?.can_send_telegram === true;
  ...
  async function sendMessage() {
    if (!canSendTelegram || !selectedConversation || (!messageText.trim() && !selectedFile)) return;
