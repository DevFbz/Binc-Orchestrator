...
export default function TerminalPage() {
  ...
  return <main className={styles.page}>
    <header className={styles.header}><Link href="/#terminal" className={styles.back}><ArrowLeft size={16} /> Binc OS</Link><span className={styles.secure}><ShieldCheck size={14} /> Terminal administrativo</span></header>
