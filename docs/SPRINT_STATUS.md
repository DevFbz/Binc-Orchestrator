...
- Sprint 19 em execução: exportação CSV do relatório executivo com período, fontes, limitações e métricas agregadas; PDF e relatórios agendados ainda pendentes.
